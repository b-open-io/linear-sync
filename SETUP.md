...
**Hooks not firing?** Run `claude plugin update linear-sync@crystal-peak` to ensure you have the latest version. For standalone installs, check that `~/.claude/settings.json` has the hook entries.
